local L = LibStub("AceLocale-3.0"):NewLocale("TownsfolkTracker", "koKR", false)
...
L["Transportation"] = "이동"
-- Professions
L["Primary Professions"] = "전문 기술"
L["Secondary Professions"] = "보조 기술"
L["Other Training"] = "기타 기술"
L["Alchemy"] = "연금술"
...
L["Required Level"] =  "필요 레벨"
L["Recommended Level"] = "권장 레벨"
L["Raid Size"] = "공격대 인원"
L["Cave Entrance"] = "인던 입구"
...
-- NPC Tags
-- Classes
L["Druid Trainer"] = "드루이드 상급자"
L["Hunter Trainer"] = "사냥꾼 상급자"
L["Pet Trainer"] = "야수 조련사"
L["Mage Trainer"] = "마법사 상급자"
L["Portal Trainer"] = "순간이동 전문 마법사"
L["Paladin Trainer"] = "성기사 상급자"
L["Priest Trainer"] = "사제 상급자"
L["Rogue Trainer"] = "도적 상급자"
L["Shaman Trainer"] = "주술사 상급자"
L["Warlock Trainer"] = "흑마법사 상급자"
L["Demon Trainer"] = "악마 훈련사"
L["Warrior Trainer"] = "전사 상급자"
-- Professions
L["Cooking Trainer"] = "요리 전문가"
L["First Aid Trainer"] = "응급치료 전문가"
L["Fishing Trainer"] = "낚시 전문가"
L["Herbalism Trainer"] = "약초채집 전문가"
L["Skinning Trainer"] = "무두질 전문가"
L["Mining Trainer"] = "채광 전문가"
L["Tailoring Trainer"] = "재봉술 전문가"
L["Leatherworking Trainer"] = "가죽세공 전문가"
L["Blacksmithing Trainer"] = "대장기술 전문가"
L["Alchemy Trainer"] = "연금술 전문가"
L["Engineering Trainer"] = "기계공학 전문가"
L["Enchanting Trainer"] = "마법부여 전문가"
...
L["Skull Rock, Durotar"] = "듀로타 - 해골 바위굴"
L["Brill, Tirisfal Glades"] = "티리스팔 숲 - 브릴"
L["Grom'gol Base Camp, Stranglethorn Vale"] = "가시덤불 골짜기 - 그롬골 주둔지"
L["Ratchet, The Barrens"] = "불모의 땅 / 톱니항"
L["Booty Bay, Stranglethorn Vale"] = "가시덤불 골짜기 / 무법항 행"
L["Menethil Harbor, Wetlands"] = "저습지 / 메네실 항구 행"
L["Auberdine, Darkshore"] = "어둠의 해안 / 아우버다인 행"
L["Rut'theran Village, Teldrassil"] = "텔드랏실 / 루테란 마을 행"
L["Thereamore Isle, Dustwallow Marsh"] = "먼지진흙 습지대 / 테라모어"
L["Deeprun Tram, Stormwind City"] = "지하철 - 스톰윈드 행"
L["Deeprun Tram, Ironforge"] = "지하철 - 아이언포지 행"
L["Darnassus, Teldrassil"] = "텔드랏실 / 다르나서스"
...
L["Townsfolk Tracker"] = "Townsfolk Tracker"
L["Click"] = "클릭"
L["Choose Townsfolk"] = "Townsfolk 선택"
L["Right Click"] = "오른쪽 클릭"
L["Open Options"] = "설정 열기"
L["Show Minimap Button"] = "미니맵 버튼 보이기"
L["Toggles the display of the minimap button."] = "미니맵 버튼을 보이거나 숨깁니다"
L["Show All Class Trainers"] = "모든 직업의 상급자 보이기"
L["Toggles the display of all class trainers or only your for your class."] = "지금 캐릭터의 직업만 보이거나, 모든 직업의 상급자를 보이거나 선택합니다"
L["WorldMapDescription"] = [[

|cffffd000Map Tracking|r
지도에 추적 대상들이 표시됩니다.
지도에서의 표시를 해제하면 버튼까지도 비활성화 됩니다.]]
L["Track On Map"] = "지도에 표시하기"
L["Toggles tracking on the map."] = "지도에 표시하거나 숨깁니다"
L["Show Map Button"] = "지도에 버튼 표시"
L["Toggles the display of the map button."] = "지도에 버튼을 표시하거나 숨깁니다"
L["Show Instances On World Map"] = "세계지도에 던전들을 표시합니다"
L["Toggles the display of dungeons and raids on the fully zoomed out world map."] = "최대로 축소화된 지도에 던전/레이드 던전들을 표시하거나 숨깁니다"
L["Reset Tracking"] = "추적 내용 초기화"
L["Tracking menu bugged after an update? Click here to reset it to the default."] = "업데이트 이후 버그가 있나요? 클릭하여 기본값으로 초기화합니다"
L["Tracking list reset."] = "Townsfolk 추적 리스트 초기화"
