...
function DCP:CreateOptionsFrame()
    local sliders = {
        { text = "아이콘 크기", value = "iconSize", min = 30, max = 125, step = 5 },
        { text = "표시할 시간", value = "fadeInTime", min = 0, max = 1.5, step = 0.1 },
        { text = "사라짐 시간", value = "fadeOutTime", min = 0, max = 1.5, step = 0.1 },
        { text = "최대 불투명도", value = "maxAlpha", min = 0, max = 1, step = 0.1 },
        { text = "최대 불투명도 유지 시간", value = "holdTime", min = 0, max = 1.5, step = 0.1 },
        { text = "애니메이션 비율", value = "animScale", min = 0, max = 2, step = 0.1 },
    }

    local buttons = {
        { text ="닫기", func = function(self) self:GetParent():Hide() end },
        { text = "테스트", func = function(self)
            DCP_OptionsFrameButton3:SetText("이동")
        ...
        { text = "이동", func = function(self)
            if (self:GetText() == "이동") then
                RefreshLocals()
    ...
    petcolorselect:SetScript("OnEnter",function(self) GameTooltip:SetOwner(self, "ANCHOR_CURSOR") GameTooltip:SetText("주의: 소환수 재사용 대기시간 오버레이를 사용하지 않으려면 흰색을 선택하세요.") end)
    ...
    spellnametext:SetText("주문 이름 표시:")
    ...
    ignoretext:SetText("재사용 대기시간 무시:")
    ...
    ignoretypetextblacklist:SetText("목록제외")
    ...
    ignoretypetextwhitelist:SetText("목록추가")
    ...
    ignorebox:SetScript("OnEnter",function(self) GameTooltip:SetOwner(self, "ANCHOR_CURSOR") GameTooltip:SetText("주의: 여러 개의 주문을 입력할 경우 컴마로 구분하세요.") end)
